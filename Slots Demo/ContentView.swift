...
//  Slots Demo
//
//  Created by Xzavier dunn on 5/28/20.
...
//            alert(isPresented: $jackPot) { () -> Alert in
//                Alert(title: Text("You won the jackpot!"), message: Text("500 Credits"), dismissButton: .default(Text("Dismiss"), action: () -> self.jackPot = false))
//            }
    ...
    func processWin(_ isMax:Bool = false) {
        ...
        if !isMax {
            ...
            // Jack pot check
            if isMatch(0, 1, 2) && isMatch(3, 4, 5) && isMatch(6, 7, 8) {
